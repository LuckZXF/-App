...
class evaluate11message : UIViewController,UIAlertViewDelegate {
    ...
    @IBAction func exit(sender : AnyObject)
    {
        ...
        evaluate11.removeAll(keepCapacity: true)
        evaluate22.removeAll(keepCapacity: true)
