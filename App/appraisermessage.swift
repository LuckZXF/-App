...
class appraisermessage : UIViewController , UIAlertViewDelegate {
    ...
    @IBAction func exit(sender : AnyObject)
    {
        ...
        appraiser1.removeAll(keepCapacity: true)
        appraiser2.removeAll(keepCapacity: true)
