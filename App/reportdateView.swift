...
class reportdateView : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if(shenfen == 1)
        {
        datelabel.text = liebiao1[22]
        }
        else if (shenfen == 5)
        {
            datelabel.text = money2[16]
        }
        else if (shenfen == 6)
        {
    ...
    func buttonAction(sender : UIButton) {
        ...
        case 2:
            ...
            liebiao1[22] = "\(datePicker.date)"
             ...
             {
                money2[16] = "\(datePicker.date)"
                datelabel.text = money2[16]
             }
             else if(shenfen == 6)
             {
                writing2[13] = "\(datePicker.date)"
                datelabel.text = writing2[13]
             }
             isSave = true
